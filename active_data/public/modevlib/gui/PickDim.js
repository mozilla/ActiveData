...
PickDim.prototype.getQuery=function(){
  ...
  if (self.focus){
    ...
    }else if (numSelected>0 && currentSelection[0].field&& jx.domain.ALGEBRAIC.contains(currentSelection[0].type)){
    ...
    }else if (numSelected>0 && currentSelection[0].field && jx.domain.PARTITION.contains(currentSelection[0].type)){
      var s=currentSelection[0];
      edges.push({
        "name":s.name,
        "value":s.field,
