...
# MAGICAL GUNICORN PATH MINI-LANGUAGE (True to most *nix help, the most important is left out)
#
# usage: gunicorn [OPTIONS] [APP_MODULE]
#
# APP_MODULE - is in the form <MODULE_PATH> ":" <METHOD_NAME> <OPTIONAL_PARAMETERS>
#              where
