...
class TestSetOps(BaseTestCase):
    def test_length(self):
        test = {
            ...
            "expecting_list": {"meta": {"format": "list"}, "data": [1, 2, 3, 4, 5]},
            "expecting_table": {
                "meta": {"format": "table"},
                "header": ["l"],
                "data": [[1], [2], [3], [4], [5]],
    ...
    def test_eq(self):
        test = {
            ...
            "query": {"from": TEST_TABLE, "select": ".", "where": {"eq": ["a", "b"]}},
            "expecting_list": {
                "meta": {"format": "list"},
        ...
        test = {
            ...
            "query": {
                ...
                "select": [
                    ...
                    {
                        "name": "io",
                        "value": {"when": {"eq": ["a", "b"]}, "then": 1, "else": 2},
                    },
                ],
            },
            "expecting_list": {
        ...
        test = {
            ...
            "query": {
                ...
                "select": [
                    "a",
                    "b",
                    {"name": "t", "value": {"add": ["a", "b"], "nulls": True}},
                ],
            },
            "expecting_list": {
                "meta": {"format": "list"},
    ...
    def test_select_add_w_default(self):
        test = {
            "data": [{"a": 1, "b": -1}, {}],  # DUMMY VALUE TO CREATE COLUMNS
            "query": {
                "from": TEST_TABLE,
                "select": [
                    "a",
                    "b",
                    {"name": "t", "value": {"add": ["a", "b"], "default": -5}},
                ],
            },
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [{"a": 1, "b": -1, "t": 0}, {"t": -5}],
            },
        }
        self.utils.execute_tests(test)
    ...
    def test_find(self):
        test = {
            ...
            "query": {
                "from": TEST_TABLE,
                "select": ["v", {"name": "f", "value": {"find": {"v": "test"}}}],
            },
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
    ...
    def test_where_or_find(self):
        test = {
            "data": [{"v": "test"}, {"v": "not test"}, {"v": null}, {}, {"v": "a"}],
            "query": {"from": TEST_TABLE, "where": {"or": [{"find": {"v": "test"}}]}},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [{"v": "test"}, {"v": "not test"}],
            },
    ...
    def test_where_and_find(self):
        test = {
            "data": [{"v": "test"}, {"v": "not test"}, {"v": null}, {}, {"v": "a"}],
            "query": {"from": TEST_TABLE, "where": {"and": [{"find": {"v": "test"}}]}},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [{"v": "test"}, {"v": "not test"}],
            },
    ...
    def test_number(self):
        test = {
            ...
            "expecting_list": {"meta": {"format": "list"}, "data": [1, 2, 3, 4, NULL]},
        }
        self.utils.execute_tests(test)
    ...
    def test_div_with_default(self):
        test = {
            ...
            "expecting_list": {"meta": {"format": "list"}, "data": [0, 0.5, 1, 10]},
        }
        self.utils.execute_tests(test)
    ...
    def test_div_wo_default(self):
        test = {
            ...
            "expecting_list": {"meta": {"format": "list"}, "data": [0, 0.5, 1, NULL]},
        }
        self.utils.execute_tests(test)
    ...
    def test_date_on_duration(self):
        test = {
            ...
            "query": {
                "from": TEST_TABLE,
                "select": {"name": "test", "value": {"date": "day"}},
            },
            "expecting_list": {"meta": {"format": "list"}, "data": [86400, 86400]},
        }
    ...
    def test_prefix_w_when(self):
        test = {
            ...
            "expecting_list": {"meta": {"format": "list"}, "data": [1, 1, NULL]},
        }
    ...
    def test_boolean_in_where_clause1(self):
        test = {
            ...
            "query": {"from": TEST_TABLE, "where": {"in": {"result.ok": ["F"]}}},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
                    {"result": {"ok": False}},
    ...
    def test_boolean_in_where_clause2(self):
        test = {
            ...
            "query": {"from": TEST_TABLE, "where": {"not": "result.ok"}},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [
                    {"result": {}},
    ...
    def test_in_with_singlton(self):
        test = {
            ...
            "query": {"from": TEST_TABLE, "where": {"in": {"a": "b"}}},
            "expecting_list": {
                "meta": {"format": "list"},
                "data": [{"a": "b"}, {"a": "b"}, {"a": "b"}],
            },
    ...
    def test_float_div_by_integer(self):
        test = {
            ...
            "expecting_list": {"meta": {"format": "list"}, "data": [1000]},
        }
