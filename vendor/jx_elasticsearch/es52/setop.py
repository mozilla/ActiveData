...
def get_pull_stats(prefix_path, stats_name, median_name):
    return jx_expression_to_function({"select": [
        {"name": "count", "value": join_field([prefix_path, stats_name, "count"])},
        {"name": "sum", "value": join_field([prefix_path, stats_name, "sum"])},
        {"name": "min", "value": join_field([prefix_path, stats_name, "min"])},
        {"name": "max", "value": join_field([prefix_path, stats_name, "max"])},
        {"name": "avg", "value": join_field([prefix_path, stats_name, "avg"])},
        {"name": "sos", "value": join_field([prefix_path, stats_name, "sum_of_squares"])},
        {"name": "std", "value": join_field([prefix_path, stats_name, "std_deviation"])},
        {"name": "var", "value": join_field([prefix_path, stats_name, "variance"])},
        {"name": "median", "value": join_field([prefix_path, median_name, "values", "50.0"])}
    ]})
